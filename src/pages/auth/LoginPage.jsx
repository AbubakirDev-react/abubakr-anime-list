        ...
        <form className='w-full' onSubmit={onSubmit}>
            <div className='flex flex-col'>
                ...
                <div className='flex items-center rounded-md  pl-3 outline-1 -outline-offset-1 outline-gray-600 has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-indigo-500'>
                    ...
                    <input onChange={(e)=>setEmail(e.target.value)} type="email" placeholder='Ваша почта' id='email' className='block min-w-0 grow bg-gray-800 py-1.5 pr-3 pl-1 text-base text-white placeholder:text-gray-500 focus:outline-none sm:text-sm/6' />
                </div>
            </div>
            <div className='flex flex-col'>
                ...
                <div className='flex items-center rounded-md  pl-3 outline-1 -outline-offset-1 outline-gray-600 has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-indigo-500'>
                    ...
                    <input onChange={(e)=>setPassword(e.target.value)} type="password" placeholder='Ваш пароль' id='pwd' className='block min-w-0 grow bg-gray-800 py-1.5 pr-3 pl-1 text-base text-white placeholder:text-gray-500 focus:outline-none sm:text-sm/6' />
                </div>
            </div>
